...
export const DEMO_PRODUCTS = [
  {
    id: 'prod-1', name: 'Cuenco de gres', price: 28, categoryId: 'cat-ceramica', supplierId: 'sup-ceramica',
  ...
  {
    id: 'prod-2', name: 'Taza mate', price: 22, categoryId: 'cat-ceramica', supplierId: 'sup-ceramica',
    image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop',
    description: 'Taza de cerámica mate, ideal para el desayuno diario.',
    stock: 8, active: true,
  },
  {
    id: 'prod-3', name: 'Mantel lino', price: 65, categoryId: 'cat-textil', supplierId: 'sup-textil',
    image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=400&fit=crop',
    description: 'Mantel de lino teñido con plantas. Hecho en taller sevillano.',
    stock: 5, active: true,
  },
  {
    id: 'prod-4', name: 'Cojín bordado', price: 38, categoryId: 'cat-textil', supplierId: 'sup-textil',
  ...
  {
    id: 'prod-5', name: 'Bandeja de olivo', price: 45, categoryId: 'cat-madera', supplierId: 'sup-madera',
  ...
  {
    id: 'prod-6', name: 'Salero dual', price: 18, categoryId: 'cat-madera', supplierId: 'sup-madera',
